...
const Attendance = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`${API_BASE_URL}/supervisor/myInterns`, {
            headers: {
    ...
    const handleMarkAttendance = (internId) => {
        ...
        axios.post(`${API_BASE_URL}/supervisor/attendance?internId=${internId}&date=${formattedDate}`, {}, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
            }
    ...
    const handlePastAttendance = (internId, internName) => {
        ...
        axios.get(`${API_BASE_URL}/supervisor/attendance/${internId}`, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
            }
