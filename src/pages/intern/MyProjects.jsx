  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch((err) => {
        ...
        setError(
          "Failed to fetch your project data. Please check your internet connection or try again later."
        );
        setLoading(false);
      });
  }, []);
    ...
    <div className="min-h-screen bg-gradient-to-br py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h1
            className="text-4xl font-bold bg-gradient-to-r from-[#4db849] to-[#4db849] bg-clip-text text-transparent mb-2"
            role="heading"
            aria-level="1"
          >
          ...
          <p className="text-gray-600">
            Track and manage your internship projects
          </p>
        </div>
            ...
            <Card className="w-full shadow-lg border-0 bg-gradient-to-r">
              <CardBody className="p-6">
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    <h2
                      className="text-2xl font-bold mb-1 text-slate-500"
                      role="heading"
                      aria-level="2"
                    >
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {internData.projects.map((project, index) => {
                    const otherTeamMembers = project.interns
                      ? project.interns.filter(
                          (intern) =>
                            intern.internId !== internData.intern.internId
                        )
                      : [];
                                  ...
                                  <div>
                                    ...
                                    {otherTeamMembers.length > 6 && (
                                      <p
                                        ...
                                        aria-live="polite"
                                      >
                                        +{otherTeamMembers.length - 6} more team
                                        members
                                      </p>
                                    )}
                                  </div>
                ...
                <Card className="w-full shadow-lg border-0 bg-gradient-to-r from-[#e0f2fe]">
                  <CardBody className="p-12 text-center">
                    ...
                    <p className="text-gray-500 mb-6">
                      You haven't been assigned any projects yet. Check back
                      later!
                    </p>
                    <Tooltip
                      content="Refresh to check for new projects"
                      placement="top"
                    >
                      <Button
                        color="primary"
