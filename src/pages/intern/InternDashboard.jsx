  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const resumeResponse = await axios.post(
        `${API_BASE_URL}/intern/apply/resumeUpload`,
        fileData,
        {
          headers: {
      ...
      <Card className="w-2/3 p-8">
        <CardHeader className="flex justify-center mb-4">
          <h1 className="text-2xl font-semibold text-green">
            Apply for your internship with SLTMobitel - Digital Platforms
          </h1>
        </CardHeader>
        <CardBody>
          <ol className="list-decimal pl-4 text-sm text-gray-500 space-y-1 mb-12">
            <li>
              Complete all fields in the application form accurately before
              submitting.
            </li>
            <li>
              If selected, you will receive an email with further instructions
              and details about the process.
            </li>
            <li>
              The email will include a date for an in-person meeting. On that
              day, bring all required documents listed below.
            </li>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>National Identity Card (NIC) Copy</li>
              <li>Police Report</li>
              <li>
                Letter from the University Confirming the Eligibility to
          ...
          <div className="flex flex-col gap-y-8 md:container md:mx-auto">
            ...
            <div className="flex w-full flex-wrap md:flex-nowrap md:mb-0 gap-6">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("internshipPeriod", e.target.value)
                }
              />
            </div>
            ...
            <div className="flex w-full flex-wrap mt-12 md:flex-nowrap md:mb-0 gap-6">
              ...
              <Select
                ...
                onChange={(e) =>
                  handleChange("programmingLanguages", e.target.value)
                }
              >
            ...
            <div className="flex flex-col gap-4 mt-12">
              ...
              <div className="flex gap-2 items-center">
                <input
                  type="file"
                  class="file-input w-full file-input-sm file-input-blue max-w-xs"
