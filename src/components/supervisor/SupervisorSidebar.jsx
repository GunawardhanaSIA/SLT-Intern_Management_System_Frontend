...
export default function SupervisorSidebar({children}) {
            ...
            <div className='border-t border-zinc-200 flex p-3'>
                ...
                <div className={`flex justify-between items-center overflow-hidden transition-all ${expanded ? "w-52 ml-3": "w-0"}`}>
                    <div className='leading-4'>
                        <h4 className='font-semibold text-zinc-600'>Supervisor</h4>
                        <span className='text-xs text-zinc-600'>supervisor@gmail.com</span>
                    </div>
...
export function SupervisorSidebarItem({icon, text, active, alert}) {
