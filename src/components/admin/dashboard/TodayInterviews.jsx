...
const TodayInterviews = () => {
  ...
  const [selectedSupervisor, setSelectedSupervisor] = useState(null);
    ...
    useEffect(() => {
      ...
      axios.get(`${API_BASE_URL}/admin/applicants`,
        {
          headers: {
    ...
    const handleSaveIntern = (applicant, selectedSupervisor) => {
      ...
      try {
        const postResponse = fetch(`${API_BASE_URL}/admin/createIntern?userId=${applicant.user.id}&applicantId=${applicant.applicantId}&supervisorId=${selectedSupervisor}`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`,
