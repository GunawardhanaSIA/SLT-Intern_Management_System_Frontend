...
import InternSidebar, {
  InternSidebarItem,
} from "../components/intern/InternSidebar";
...
const Intern = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      axios
        .get(`${API_BASE_URL}/intern/getIntern/${userID}`, {
          headers: {
        ...
        <InternSidebar onExpandChange={handleSidebarExpandChange}>
          {sidebarItems.map((item) => (
            <Link
              ...
              onClick={() =>
                intern || item.alwaysEnabled
                  ? handleSidebarItemClick(item.title)
                  : null
              }
              className={
                intern || item.alwaysEnabled
            ...
            >
              <InternSidebarItem
                ...
                active={
                  ...
                  (item.path === "/intern" && location.pathname === "/intern")
                }
